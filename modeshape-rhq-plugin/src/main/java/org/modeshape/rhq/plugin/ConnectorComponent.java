...
//			ManagedComponent mc = DmrUtil.getManagedEngine(getConnection());
//			if (mc!=null){
//				value = ModeShapeModuleView.executeManagedOperation(mc,
//						"pingConnector", args);
//				pingResultSuccess = DmrUtil.booleanValue(value);
//			}else{
...
//		}
		...
		return AvailabilityType.UP; // (pingResultSuccess) ? AvailabilityType.UP
