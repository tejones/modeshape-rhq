...
import org.teiid.rhq.plugin.ConfigurationWriteDelegate;
...
public abstract class Facet extends BaseComponent<BaseComponent<?>> implements
   ...
   Address address;
	...
	protected void execute(final ASConnection connection,
		...
		ModeShapeModuleView msView = new ModeShapeModuleView();

		try {
			msView.executeOperation(connection, result, valueMap);
		} catch (Exception e) {
